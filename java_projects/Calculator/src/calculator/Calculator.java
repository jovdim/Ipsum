...
public class Calculator implements ActionListener {
    ...
    Calculator() {
        ...
        for (int x = 0; 9 > x; x++) {
            functionButtons[x].addActionListener(this);
            functionButtons[x].setFont(myFont);
            functionButtons[x].setFocusable(false);
        }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == delButton) {
            ...
            textfield.setText("");
            for (int x = 0; del.length() - 1 > x; x++) {
                textfield.setText(textfield.getText() + del.charAt(x));
